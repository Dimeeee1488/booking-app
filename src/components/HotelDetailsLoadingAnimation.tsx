  ...
  return (
    <div className="hotel-details-loading">
      <div className="loading-content">
        ...
        {/* Loading Text */}
        <h3 className="loading-title">{t('loadingHotelDetails')}</h3>
        <p className="loading-description">{t('gettingBestInformation')}</p>
